...
import bit.java39.utils.DBConnectionPool01;
 ...
 */
public class EmployeeList02 extends HttpServlet {
	@Override
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		DBConnectionPool01 dbPool = null;
		Connection con = null;
		Statement stmt = null;
		ResultSet rs = null;
		
		try {
			dbPool = DBConnectionPool01.getInstance(
